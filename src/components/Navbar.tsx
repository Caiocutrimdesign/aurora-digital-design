...
const WHATSAPP_URL =
  "https://wa.me/5598985992136?text=Ol%C3%A1%2C%20vim%20pelo%20site%20e%20tenho%20interesse%20no%20plano%20da%20TopyPro.";
const Navbar = () => {
  ...
  return (
    ...
    >
      <div className="container-tight py-4 px-4 md:px-8">
        <div className="flex flex-col items-center gap-4">
          <a href="#" className="flex items-center gap-3">
            <img src={logo} alt="TopyPro" className="h-14 w-14 md:h-16 md:w-16" />
          </a>
      ...
      <button onClick={() => setMenuOpen(!menuOpen)} className="md:hidden text-foreground absolute right-4 top-4">
